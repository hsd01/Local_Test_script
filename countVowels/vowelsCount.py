...
#
# Complete the 'vowelsCount' function below.
#
# The function is expected to return integer of vowelsCount present in string.
# The function accepts string, string as parameter.
#function should return total count of vowels in int
#
